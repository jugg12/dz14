...
import "./registraciya.css";
import {Link,useHistory} from "react-router-dom";
import Otpravka from "./otpravka";
...
const Registraciya = () =>{
  const validationSchema=yup.object().shape({
    ...
    recaptcha: yup.boolean().isTrue().required(),
  })
    ...
    <Formik 
      ...
      {({values,errors,touched,handleChange,handleBlur,setFieldValue,isValid,handleSubmit,dirty})=>(
        <Form className="Regforma" >
          <div className="Delenie">
            <div className="Osnovnoe">
              <h1 className="Avtorization">Регистрация</h1>
                <div className="LogPass">
                  <Field className={((touched.login && errors.login)||(values.login==="")||(Login==false))? "login__error":"login"} onChange={handleChange} onBlur={handleBlur} validate={validateLogin} value={values.login} style={{width:"75.5%"}} name = "login" type="text" placeholder="Логин" />
                    <svg className={((touched.login && errors.login)||(values.login==="")||(Login==false))? "icon__error":"iconHidden"} style={{right:"55.5%"}} width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="MAIL">
                    <Field className={((touched.email && errors.email)||(values.email==="")||(errors.email)||(Email==false))? "login__error":"login"} onChange={handleChange} onBlur={handleBlur} validate={validateMail} value={values.email} name = "email" type="mail" placeholder="Электронная почта" />
                      <svg className={((touched.email && errors.email)||(values.email==="")||(errors.email)||(Email==false))? "icon__error":"iconHidden"} style={{right:"55.5%"}} width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.5 0C5 0 0.5 4.5 0.5 10C0.5 15.5 5 20 10.5 20C16 20 20.5 15.5 20.5 10C20.5 4.5 16 0 10.5 0ZM10.5 2C11.6 2 12.4 2.9 12.3 4L11.5 12H9.5L8.7 4C8.6 2.9 9.4 2 10.5 2ZM10.5 18C9.4 18 8.5 17.1 8.5 16C8.5 14.9 9.4 14 10.5 14C11.6 14 12.5 14.9 12.5 16C12.5 17.1 11.6 18 10.5 18Z" fill="#EB5757"/>
                      </svg>
                      <svg className="MessOf"width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g className = "Mess" opacity="0.3" clip-path="url(#clip0_2831_1591)">
                  ...
                  <div className="PASSWORD" style={{marginBottom:"20px"}}>
                    <Field className={((touched.password && errors.password)||(values.password==="")||(values.password.length<6))?"password__error":"password"} onChange={handleChange} onBlur={handleBlur} name = "password" value={values.password} type="password" placeholder="Пароль" />
                      <svg className={((touched.password && errors.password)||(values.password==="")||(values.password.length<6))? "icon__error":"iconHidden"} style={{right:"55.5%"}} width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.5 0C5 0 0.5 4.5 0.5 10C0.5 15.5 5 20 10.5 20C16 20 20.5 15.5 20.5 10C20.5 4.5 16 0 10.5 0ZM10.5 2C11.6 2 12.4 2.9 12.3 4L11.5 12H9.5L8.7 4C8.6 2.9 9.4 2 10.5 2ZM10.5 18C9.4 18 8.5 17.1 8.5 16C8.5 14.9 9.4 14 10.5 14C11.6 14 12.5 14.9 12.5 16C12.5 17.1 11.6 18 10.5 18Z" fill="#EB5757"/>
                      </svg>
                      <svg className="LockOf" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g className="Lock" opacity="0.3" clip-path="url(#clip0_2831_1557)">
                  ...
                  <div className="PASSWORD2">
                    <Field className={((touched.password2 && errors.password2)||(values.password===""))?"password__error":"password"} onChange={handleChange} onBlur={handleBlur} value={values.password2} name = "password2" type="password" placeholder="Повторите пароль" />
                      <svg className={((touched.password2 && errors.password2)||(values.password2===""))? "icon__error":"iconHidden"} style={{right:"55.5%"}} width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.5 0C5 0 0.5 4.5 0.5 10C0.5 15.5 5 20 10.5 20C16 20 20.5 15.5 20.5 10C20.5 4.5 16 0 10.5 0ZM10.5 2C11.6 2 12.4 2.9 12.3 4L11.5 12H9.5L8.7 4C8.6 2.9 9.4 2 10.5 2ZM10.5 18C9.4 18 8.5 17.1 8.5 16C8.5 14.9 9.4 14 10.5 14C11.6 14 12.5 14.9 12.5 16C12.5 17.1 11.6 18 10.5 18Z" fill="#EB5757"/>
                      </svg>
                      <svg className="LockOf2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g className="Lock2" opacity="0.3" clip-path="url(#clip0_2831_1557)">
              ...
              <div className={((Login==false)||(values.login=="")||(errors.email)||(Email==false)||(values.password.length<6)||(errors.password2))?"Zabil ZabilOpacity":"Zabil"}>
                ...
                value={capcha}
                />
                {errors.recaptcha&& touched.recaptcha && (values.recaptcha==capcha)}
              </div>
              <div className={("OshibkaVvoda" && ((touched.login&&errors.login)||(touched.password && errors.password)||(Login==false)||(errors.email)||(Email==false)||(values.password.length<6)||(errors.password2)||(capcha==false)))? "OshibkaVvoda fix":"OshibkaVvoda"}>
                  <div className="">
                    <p className="OshibkaVvodaText">{((Login==false?"Такой логин уже занят":"")||((values.login=="")?"Логин не может быть пустым":"")||((errors.email)?`${errors.email}`:"")||((Email==false)?"Такой email занят":"")||((values.password.length<6)?"Символы в пароле<6":"")||((errors.password2)?`${errors.password2}`:"")||((capcha==false)?"Капча":""))}</p>
                  </div>
                  <div className="">
                ...
                <button className="Registrationbtn" id="btn" disabled={!isValid} onClick={()=>{handleSubmit}} type="submit">Зарегистрироваться</button>
            </div>
            <div className="Dop">
              ...
              <div className="last__item__registraciya">
                ...
                <Link to="/Vhod" className="Registration zabpas"> Войдите</Link>
              </div>
            </div>
          </div>
        </Form>
